...
/*                                                                            */
/*                                                        :::      ::::::::   */
/*   tangent_plane_bonus.c                              :+:      :+:    :+:   */
/*                                                    +:+ +:+         +:+     */
/*   By: gyyu <gyyu@student.42seoul.kr>             +#+  +:+       +#+        */
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2022/09/28 17:05:07 by iyun              #+#    #+#             */
/*   Updated: 2022/10/07 12:49:54 by gyyu             ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
	...
	t_meet meet_point, t_point *nor_vec, t_minirt info)
{
	...
	cylinder->under_cent, &temp_vec);
	temp_point = cylinder->normal_vec;
	n_multi_vec(dot_product(meet_point.dir_vec, cylinder->normal_vec), \
	&temp_point);
...
double	get_alpha(t_meet meet_point, t_minirt info)
{
	...
	alpha += meet_point.parm_t * \
	dot_product(meet_point.dir_vec, cone->normal_vec);
...
void	cone_tangent_plane(t_meet meet_point, t_point *nor_vec, t_minirt info)
{
	...
	vec_minus_vec(info.necessity.camera.view_point, cone->under_cent, \
	&temp_vec);
...
t_point	*ft_normal_vec(t_meet meet_point, t_minirt info)
{
	...
	if (meet_point.object_type == PLANE)
		*nor_vec = ((t_plane *)(meet_point.object))->normal_vec;
		...
		vec_minus_vec(meet_point.meet, \
		((t_sphere *)(meet_point.object))->center, nor_vec);
