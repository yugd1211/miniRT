...
/*   Updated: 2022/10/07 13:17:37 by iyun             ###   ########seoul.kr  */
/*                                                                            */
/* ************************************************************************** */
...
void			cylinder_tangent_plane(t_meet meet_point, t_point *nor_vec, \
				t_minirt info);
double			get_alpha(t_meet meet_point, t_minirt info);
void			cone_tangent_plane(t_meet meet_point, t_point *nor_vec, \
				t_minirt info);
...
void			bump_map_check(t_object **object, char **list, int *idx, \
				t_minirt info);
...
void			ambient_reflex(double coef, t_color obj_color, \
				t_color *coloring);
void			ambient_light(t_minirt info, t_phong *draw);
double			coef_disfusion_reflex(t_meet meet_point, t_light light, \
				t_point nor_vec);
void			disfusion_reflex(double coef, t_color obj_color, \
				t_color light, t_color *coloring);
t_correlation	ft_correlation(t_meet meet_point, t_light light, \
				t_minirt info, t_point nor_vec);
void			phong_reflexion(t_meet meet_point, t_light light, \
				t_minirt info, t_phong *draw);
double			coef_specular_reflex(t_meet meet_point, t_light light, \
				t_minirt info, t_point nor_vec);
void			specular_reflex(double coef, t_color light, t_color *coloring);
void			ft_check_hit_obj(t_meet *meet, t_object *temp_object, \
				t_line line);
//get_hit_point
void			renew_parm_t(t_object object, t_meet *meet, t_line line, \
				t_type type);
...
int				vec3_to_uv(t_meet meet_point, double *u, double *v, \
				t_minirt info);
void			sphere_uv(double *u, double *v, t_meet meet_point);
void			plane_uv(double *u, double *v, t_meet meet_point);
void			cylinder_cone_uv(double *u, double *v, t_meet meet_point, \
				t_minirt info);
